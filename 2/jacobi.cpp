// Лабораторная работа: решение СЛАУ методом Якоби (простой итерации)
// Точность eps = 0.01
#include <iostream>
#include <iomanip>
#include <clocale>
...
int main()
{
    ...
    cout << "Решение по методу Якоби:" << endl;
    ...
    do
    {
        // Считаем новое приближение ТОЛЬКО по старым значениям xStar
        for (int i = 0; i < N; i++)
        {
            double summa = 0;
            for (int j = 0; j < N; j++)
